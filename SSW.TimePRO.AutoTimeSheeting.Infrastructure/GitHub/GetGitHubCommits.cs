...
{
    public class GetGitHubCommitsQuery : IGetGitHubCommitsQuery
    {
        private const string BaseUrl = "https://api.github.com";

        public async Task<GitCommitResult> Execute(GetGitHubCommitsRequest request)
        {
    ...
    {
        Task<GitCommitResult> Execute(GetGitHubCommitsRequest request);
    }
}
